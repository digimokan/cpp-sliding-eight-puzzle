...
TEST_CASE("goal_board == start_board (1-step solution)") {
  ...
  SolverDFS solver{ Board{"123804765"}, Board{"123804765"}, std::make_shared<MoveCostSqVal>()};
...
TEST_CASE("2-step solution") {
  ...
  Board BA{ "123804765" };
  Board BB{ "123840765" };
  SolverDFS solver{ BA, BB, std::make_shared<MoveCostSqVal>()};
  auto solution{ solver.solve() };
...
TEST_CASE("3-step solution") {
  ...
  Board BB{ "123840765" };
  Board BC{ "123845760" };
  SolverDFS solver{ BA, BC, std::make_shared<MoveCostSqVal>()};
  auto solution{ solver.solve() };
...
TEST_CASE("6-step \"easy\" solution" * doctest::skip(true)) {
  ...
  Board BE{ "103824765" };
  Board BF{ "123804765" };
  SolverDFS solver{ BA, BF, std::make_shared<MoveCostSqVal>()};
  auto solution{ solver.solve() };
